...
from esphome.const import CONF_OUTPUT_ID, SCHEDULER_DONT_RUN
from esphome.core import HexInt
from esphome.components.fastcon.refresh_control import (
    REFRESH_CONTROL_SCHEMA,
    register_refresh_control,
)
